...
### 6.70.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.69.1...v6.70.0)
...
### 6.69.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.69.0...v6.69.1)

- Fixed security vulnerability by upgrading Lodash

### 6.69.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.68.1...v6.69.0)

- Added ability to pass props into `Tab` component from `NavTab`

### 6.68.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.68.0...v6.68.1)

- Fixed a bug that prevented prefetching fallback routes.

### 6.68.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.67.1...v6.68.0)
...
### 6.67.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.67.0...v6.67.1)

- Fixes a bug where `Link` elements with a `to` prop that points to a `fromOrigin` route do not work.

### 6.67.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.66.0...v6.67.0)

- You can now use `fromOrigin` and `redirectTo` in your router's `fallback` handler.

### 6.66.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.65.3...v6.66.0)
...
### 6.65.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.65.2...v6.65.3)

- Improves `utils/batchPromises` concurrent execution.

### 6.65.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.65.1...v6.65.2)

`fetch` calls made in handler functions now forward the `x-forwarded-for` request header automatically.

### 6.65.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.65.0...v6.65.1)
...
### 6.65.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.64.1...v6.65.0)
...
### 6.64.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.64.0...v6.64.1)

- Fixes `additionalDelay` bug which caused hydration before load

### 6.64.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.63.0...v6.64.0)
...
### 6.63.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.62.2...v6.63.0)
...
### 6.62.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.62.1...v6.62.2)

- Fixes metadata for analytics events that have no arguments

### 6.62.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.62.0...v6.62.1)

- Fixes metadata for analytics events that get queued before the app becomes interactive.

### 6.62.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.61.0...v6.62.0)
...
### 6.61.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.6...v6.61.0)
...
### 6.60.6 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.5...v6.60.6)

- Fixed caching for Product images

### 6.60.5 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.4...v6.60.5)

- Fixed bug in Router that allowed internal location state to get out of sync

### 6.60.4 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.3...v6.60.4)

- Improves the performance of the Menu component by only rendering the SEO links on the server.

### 6.60.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.2...v6.60.3)

- Removing the bloat of JIMP from the React Storefront server code. It was an unused dependency of the amp-optimizer

### 6.60.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.1...v6.60.2)

- Fixed a bug where the main image on a PDP will flash in on the first client-side transition from a PLP.

### 6.60.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.60.0...v6.60.1)

- Fixed `Response`'s handling of cookies. Now able to set multiple cookies.

### 6.60.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.6...v6.60.0)

- Added a `Carousel` component that supports AMP

### 6.59.6 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.5...v6.59.6)

- Added `redirected` flag to response context for downstream event handlers

### 6.59.5 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.4...v6.59.5)

- Removed buggy optimization for ExpandableSection, it conflicted with MobX and caused rendering issues.

### 6.59.4 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.3...v6.59.4)

- Fixed bug where app would scroll to the top of the page before updating the UI during client side navigation.

### 6.59.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.2...v6.59.3)
...
### 6.59.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.1...v6.59.2)

- Fix for `TabPanel` amp initial state

### 6.59.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.59.0...v6.59.1)

- Fixed AMP Menu bug which was causing sub menus not to close

### 6.59.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.58.0...v6.59.0)

- Added `Accordion` component which only allows one child `ExpandableSection` to be open at a time.

### 6.58.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.57.0...v6.58.0)
...
### 6.57.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.56.0...v6.57.0)

- Removed css minification for non-amp request to speed up execution times.

### 6.56.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.55.4...v6.56.0)
...
### 6.55.4 [diff](https://github.com/moovweb/react-storefront/compare/v6.55.3...v6.55.4)

- Added `visibilitySensorProps` to `Lazy`.

### 6.55.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.55.2...v6.55.3)

- uninstall-service-worker.js is no longer prefetched.

### 6.55.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.55.1...v6.55.2)

- Elements inside `Lazy` are now shown in AMP.

### 6.55.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.55.0...v6.55.1)
...
### 6.55.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.54.3...v6.55.0)
...
### 6.54.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.54.2...v6.54.3)
...
### 6.54.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.54.1...v6.54.2)
...
### 6.54.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.54.0...v6.54.1)

- Improved consistency of prefetch caching.

### 6.54.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.53.1...v6.54.0)

- Upgrades workbox to 4.3.1
- Fixes a bug where prefetched data always results in a cache miss when navigating to a new page.

### 6.53.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.53.0...v6.53.1)

- Fixes a bug introduced in 6.47.0 that caused responses cached in the browser to not expire properly

### 6.53.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.52.2...v6.53.0)
...
### 6.52.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.52.1...v6.52.2)

- Improves the patch from 6.52.1 to also handle the case when the product was rendered on the server.

### 6.52.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.52.0...v6.52.1)
...
### 6.52.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.51.1...v6.52.0)
...
### 6.51.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.51.0...v6.51.1)

- The `renderers/render` method is now correctly marked `async`.

### 6.51.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.50.2...v6.51.0)

- `ImageSwitcher` now uses the product name for the `alt` prop on any images or thumbnails that do not have one.

### 6.50.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.50.1...v6.50.2)

- Fixed an issue where elements inside a `Lazy` component are never rendered if they are initially above the fold.

### 6.50.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.50.0...v6.50.1)

- Fixed error when running apps in express due to `headers.get(name)` not being defined.

### 6.50.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.49.0...v6.50.0)
...
### 6.49.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.48.2...v6.49.0)
...
### 6.48.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.48.1...v6.48.2)

- Fixed AMP validation errors in `AmpImageSwitcher`.

### 6.48.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.48.0...v6.48.1)

- ImageSwitcher with color selector now works in AMP

### 6.48.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.47.0...v6.48.0)

- create-react-storefront now checks for node 8 at startup.

### 6.47.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.46.1...v6.47.0)

- Skeletons are now skipped when the URL matches a route that is cached on the client.

### 6.46.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.46.0...v6.46.1)

- Fixing AMP check in `Server`

### 6.46.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.45.0...v6.46.0)
...
### 6.45.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.44.1...v6.45.0)

- Added tracking search events for the `SearchPopup` component

### 6.44.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.44.0...v6.44.1)
...
### 6.44.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.43.2...v6.44.0)
...
### 6.43.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.43.1...v6.43.2)

- Fixed a client build issue relating to AMP exclusion.

### 6.43.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.43.0...v6.43.1)

- Prevent errors when headers forwarded by fetch are not provided by the browser.

### 6.43.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.42.2...v6.43.0)
...
### 6.42.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.42.1...v6.42.2)

- Restored the default export of `react-storefront/fetch` for backwards compatibility.

### 6.42.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.42.0...v6.42.1)

- Restored `react-storefront/fetch` for backwards compatibility.

### 6.42.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.41.0...v6.42.0)
...
### 6.41.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.40.0...v6.41.0)
...
### 6.40.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.39.0...v6.40.0)
...
### 6.39.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.38.0...v6.39.0)
...
### 6.38.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.37.1...v6.38.0)

- Adding analytics events `searchSubmitted` and `searchLinkClicked` to SearchDrawer

### 6.37.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.37.0...v6.37.1)

- Fixed webpack production build issue

### 6.37.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.36.4...v6.37.0)
...
### 6.36.4 [diff](https://github.com/moovweb/react-storefront/compare/v6.36.3...v6.36.4)

- Removes this warning about deprecated usage of `require("history/createBrowserHistory")`.

### 6.36.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.36.2...v6.36.3)
...
### 6.36.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.36.1...v6.36.2)

- `SearchResultsModelBase` nows updates `facetGroups` if defined in a search results response

### 6.36.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.36.0...v6.36.1)
...
### 6.36.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.35.1...v6.36.0)
...
### 6.35.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.35.0...v6.35.1)

- Sourcemap files are now excluded from the service worker precache manifest.

### 6.35.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.34.3...v6.35.0)
...
### 6.34.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.34.2...v6.34.3)

- Fixed prefetch throttling opt-in in production client webpack config.

### 6.34.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.34.1...v6.34.2)
...
### 6.34.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.34.0...v6.34.1)

- Fixed warning "React does not recognize the lazyLoadImages prop on a DOM element." when using `CmsSlot`.

### 6.34.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.33.1...v6.34.0)
...
### 6.33.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.33.0...v6.33.1)

- Fixed linking to JS assets introduced in 6.33.0

### 6.33.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.32.0...v6.33.0)

- Added source maps for production builds.

### 6.32.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.31.1...v6.32.0)
...
### 6.31.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.31.0...v6.31.1)
...
### 6.31.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.30.2...v6.31.0)
...
### 6.30.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.30.1...v6.30.2)

- Fixed deprecation warning: `Please use require("history").createMemoryHistory instead of require("history/createMemoryHistory")`

### 6.30.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.30.0...v6.30.1)

- `SearchDrawer` now handles a null value for `app.search.results` gracefully.

### 6.30.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.29.0...v6.30.0)
...
### 6.29.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.28.0...v6.29.0)
...
### 6.28.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.27.0...v6.28.0)
...
### 6.27.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.26.0...v6.27.0)
...
### 6.26.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.25.0...v6.26.0)
...
### 6.25.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.24.1...v6.25.0)

- The Router now explicitly adds a JSON route with each
  Route initialization
- Fixed max-age cache control header configuration

### 6.24.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.24.0...v6.24.1)

- Rerelease of 6.24.1 due to a botched build.

### 6.24.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.23.1...v6.24.0)
...
### 6.23.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.23.0...v6.23.1)
...
### 6.23.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.22.0...v6.23.0)
...
### 6.22.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.21.0...v6.22.0)
...
### 6.21.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.20.0...v6.21.0)
...
### 6.20.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.19.0...v6.20.0)
...
### 6.19.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.18.0...v6.19.0)

- Improved `MenuIcon` with better animation. Note: MenuIcon's `OpenIcon` and `CloseIcon` props have been removed.

### 6.18.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.17.0...v6.18.0)
...
### 6.17.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.16.1...v6.17.0)
...
### 6.16.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.16.0...v6.16.1)

- Updated mobx-react to correct peerDependency ^5.4.3

### 6.16.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.15.0...v6.16.0)
...
### 6.15.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.14.1...v6.15.0)
...
### 6.14.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.14.0...v6.14.1)

- Fix bug in client webpack config due to a bad merge that would prevent apps from starting.

### 6.14.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.13.2...v6.14.0)

- Added support for prefetch throttling.

### 6.13.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.13.0...v6.13.2)
...
### 6.13.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.12.1...v6.13.0)
...
### 6.12.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.12.0...v6.12.1)

- Update peerDependencies for mobx, mobx-react, and mobx-state-tree to more stable versions.

### 6.12.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.11.0...v6.12.0)
...
### 6.11.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.10.0...v6.11.0)
...
### 6.10.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.9.2...v6.10.0)
...
### 6.9.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.9.1...v6.9.2)
...
### 6.9.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.9.0...v6.9.1)

- Fixed an issue with `Link` where `onImpression` would not fire unless `prefetch="visible"` was also present

### 6.9.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.8.3...v6.9.0)
...
### 6.8.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.8.2...v6.8.3)

- Fixed a bug where a number shows in the `ImageSwitcher` component when rendered in AMP without thumbnails.

### 6.8.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.8.1...v6.8.2)
...
### 6.8.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.8.0...v6.8.1)

- Restored `AnalyticsProvider` accidentally removed in 6.8.0

### 6.8.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.7.0...v6.8.0)
...
### 6.7.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.6.2...v6.7.0)
...
### 6.6.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.6.1...v6.6.2)

- Handle `content-type: text/plain` in post bodies.

### 6.6.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.6.0...v6.6.1)

- Fixed posting from AMP when served from Google cache by adding the correct CORS headers.

### 6.6.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.5.0...v6.6.0)
...
### 6.5.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.4.0...v6.5.0)
...
### 6.4.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.3.0...v6.4.0)
...
### 6.3.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.2.0...v6.3.0)
...
### 6.2.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.1.1...v6.2.0)
...
### 6.1.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.1.0...v6.1.1)
...
### 6.1.0 [diff](https://github.com/moovweb/react-storefront/compare/v6.0.3...v6.1.0)
...
### 6.0.3 [diff](https://github.com/moovweb/react-storefront/compare/v6.0.2...v6.0.3)

- Properly handle vendor chunks for components shared between pages.

### 6.0.2 [diff](https://github.com/moovweb/react-storefront/compare/v6.0.1...v6.0.2)

- Fixed a bug causing the Filter component's apply button to be hidden on iOS.

### 6.0.1 [diff](https://github.com/moovweb/react-storefront/compare/v6.0.0...v6.0.1)

- Corrected some out-of-date peerDependencies.

### 6.0.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.13.0...v6.0.0)
...
### 5.13.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.12.1...v5.13.0)
...
### 5.12.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.12.0...v5.12.1)

- Fixes a layout issue with the `Drawer` component on iOS <= 10

### 5.12.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.11.0...v5.12.0)

- Added `AnalyticsProvider` for loading analytics on mount

### 5.11.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.10.2...v5.11.0)

- Added `AmpModal` component based on `<amp-lightbox>`.

### 5.10.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.10.1...v5.10.2)

- Fixed where links were unresponsive until all JavaScript was fully loaded.
- Removed extraneous console.log calls.

### 5.10.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.10.0...v5.10.1)

- Added `notFoundSrc` prop to `ImageSwitcher` and handle missing images before the app mounts.

### 5.10.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.9.0...v5.10.0)

- Added `searchButtonVariant` and `showClearButton` props to `SearchDrawer` to give you greater control over the behavior of the search input.
- Fixed an issue where the page scrolls to the top when a route with a `proxyUpstream` handler runs on the client.
- Added `notFoundSrc` prop to `Image` component which will be used in case the primary image source fails to load

### 5.9.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.8.2...v5.9.0)

- Removed proxy-polyfill, which was causing errors when using analytics in IE11. If you plan to support IE11 and use analytics, you must call `analytics.fire('eventName', data)` instead of the proxied methods like `analytics.eventName(data)`.

### 5.8.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.8.1...v5.8.2)

- Fixed a bug causing the Filter component's apply button to be hidden on iOS.

### 5.8.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.8.0...v5.8.1)

- Switch Webpack Bundle Analyzer to static mode so that analysis can be saved by CI

### 5.8.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.7.1...v5.8.0)
...
### 5.7.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.7.0...v5.7.1)

- Fixed case error with importing lodash/isFunction in Router.

### 5.7.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.6.3...v5.7.0)
...
### 5.6.3 [diff](https://github.com/moovweb/react-storefront/compare/v5.6.2...v5.6.3)

- Improved error handling for SSR.

### 5.6.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.6.1...v5.6.2)

- Fix layout issue with Filter title bar.
- Added warning for setting cookies on cached route

### 5.6.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.6.0...v5.6.1)

- Fix for production webpack builds with no options

### 5.6.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.5.0...v5.6.0)
...
### 5.5.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.4.0...v5.5.0)

- Added `envVariables` to webpack server options
- Added ability to set asset path base

### 5.4.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.3.2...v5.4.0)

- Added `itemRenderer` prop to `Menu`

### 5.3.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.3.1...v5.3.2)

- Fixes an issue with Chrome 71 which prevents async loading of scripts by the service worker.

### 5.3.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.3.0...v5.3.1)

- Fix bugs related to production builds

### 5.3.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.2.4...v5.3.0)
...
### 5.2.4 [diff](https://github.com/moovweb/react-storefront/compare/v5.2.3...v5.2.4)

- Fixed a bug with sending redirects in response to POST requests from AMP.

### 5.2.3 [diff](https://github.com/moovweb/react-storefront/compare/v5.2.2...v5.2.3)

- Prevents errors when webpack's OpenBrowserPlugin fails

### 5.2.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.2.1...v5.2.2)
...
### 5.2.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.2.0...v5.2.1)

- Fixed vertical alignment of + / - icons in QuantiySelector

### 5.2.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.1.1...v5.2.0)
...
### 5.1.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.1.0...v5.1.1)

- Fixed error when attempting to redirect from http to https.

### 5.1.0 [diff](https://github.com/moovweb/react-storefront/compare/v5.0.4...v5.1.0)

- Added x-rsf-response-type and x-rsf-handler headers
- TabPanel's onChange prop no longer requires selected to be controlled.

### 5.0.4 [diff](https://github.com/moovweb/react-storefront/compare/v5.0.3...v5.0.4)
...
### 5.0.3 [diff](https://github.com/moovweb/react-storefront/compare/v5.0.2...v5.0.3)
...
### 5.0.2 [diff](https://github.com/moovweb/react-storefront/compare/v5.0.1...v5.0.2)

- Corrected peerDependencies by adding "react-transition-group" and removing "react-css-transition-group"

### 5.0.1 [diff](https://github.com/moovweb/react-storefront/compare/v5.0.0...v5.0.1)
...
### 5.0.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.10.1...v5.0.0)
...
### 4.10.1 [diff](https://github.com/moovweb/react-storefront/compare/v4.10.0...v4.10.1)

- Added option to override selectedIndex in ImageSwitcher

### 4.10.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.9.0...v4.10.0)
...
### 4.9.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.8.1...v4.9.0)
...
### 4.8.1 [diff](https://github.com/moovweb/react-storefront/compare/v4.8.0...v4.8.1)

- You can now set a custom content-type using `response.set('content-type', contentType)`.

### 4.8.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.7.0...v4.8.0)
...
### 4.7.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.6.2...v4.7.0)

- ExpandableSection's expanded state can now be controlled via an expanded prop

### 4.6.2 [diff](https://github.com/moovweb/react-storefront/compare/v4.6.1...v4.6.2)

- Fixed bug with Referrer-Policy header.

### 4.6.1 [diff](https://github.com/moovweb/react-storefront/compare/v4.6.0...v4.6.1)

- Added Referrer-Policy: no-referrer-when-downgrade response header

### 4.6.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.5.1...v4.6.0)

- Added `response.json()` helper method for sending JSON data
- Fixed ShowMore infinity scrolling bug

### 4.5.1 [diff](https://github.com/moovweb/react-storefront/compare/v4.5.0...v4.5.1)

- Added `X-Frame-Options: SAMEORIGIN` response header by default.

### 4.5.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.4.2...v4.5.0)
...
### 4.4.2 [diff](https://github.com/moovweb/react-storefront/compare/v4.4.1...v4.4.2)

- Fixed XXS vulnerability where code could be injected via the URL into the canonical link tag.

### 4.4.1 [diff](https://github.com/moovweb/react-storefront/compare/v4.4.0...v4.4.1)

- Moved proxy-polyfill to dependencies.

### 4.4.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.3.0...v4.4.0)

- Static assets are now cached at the network edge.
- s-maxage is now only removed when there is no outer edge cache.

### 4.3.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.2.0...v4.3.0)

- Added `anchorProps` to Link
- Added analytics support for IE9+ via the addition of proxy-polyfill

### 4.2.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.1.0...v4.2.0)

- Added onSuccess prop to `Track`
- Prefetching now automatically resumes once page navigation is complete.

### 4.1.0 [diff](https://github.com/moovweb/react-storefront/compare/v4.0.0...v4.1.0)
